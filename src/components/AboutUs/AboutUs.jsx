  ...
  return (
    <section className={css.section}>
      <div className={css.title__wrapper}>
        <h2 className={css.title__section}>Про нас</h2>
        <FcMinus size="2em" />
      </div>
      <div className={css.text__wrapper}>
        <p className={css.text}>
          Компанія БІЗНЕС ЗВІТ займається наданням послуг у сфері
          бухгалтерського та податкового обліку. Консультування з питань
          правильності ведення документообігу. Складання та подання звітності до
          контролюючих органів. Перевірка поданих звітів та допомога з
          виправленням помилок, відновлення бухгалтерського обліку. Ми постійно
          накопичуємо досвід ведення обліку в різних сферах діяльності, що
          сприяє підвищенню кваліфікації наших фахівців.
        </p>
      </div>
